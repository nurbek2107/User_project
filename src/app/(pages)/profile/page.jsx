  ...
  return (
    <div>
      <section className='main-container grid grid-cols-2 grid-rows-11 gap-[30px]' style={{ marginTop: `30px`, marginBottom: `100px` }}>
        ...
        <div className="shadow-box rounded-3xl row-span-6">
          ...
          <div className="px-10 py-8 flex flex-col gap-6">
            {/* <UserLinks linkName={`Linkedin`} linkUrl={`/profile`} />
            <UserLinks linkName={`Instagram`} linkUrl={`/profile`} />
            <UserLinks linkName={`Facebook`} linkUrl={`/profile`} />
            <UserLinks linkName={`Twitter`} linkUrl={`/profile`} /> */}
            {
