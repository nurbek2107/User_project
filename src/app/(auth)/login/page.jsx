    ...
    let router = [
        {
            ...
            name: "Sarah L",
            imgSrc: "https://cvam.ru/wp-content/uploads/2023/10/kichkintoilar-rasim-1.webp"
        },
        {
            ...
            name: "John D",
            imgSrc: "https://cvam.ru/wp-content/uploads/2023/10/kichkintoilar-rasim-2.webp"
        },
        {
            text: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Modi iusto ea sunt distinctio nemo veniam, ipsum in quae.",
            name: "Emily R",
            imgSrc: "https://cvam.ru/wp-content/uploads/2023/10/kichkintoilar-rasim-3.webp"
        }
    ];
    ...
    return (
        <div className="div-1 max-w-[1200px] mx-auto">
            ...
            <div className="div-3 bg-white">
                <h2 className="font-[600] text-[40px] text-[#262626]">Login</h2>
                <p className="text-[14px] text-[#4C4C4D] mt-[10px] tracking-[1px]">Welcome back! Please log in to access your account.</p>
                <form action="">
                    ...
                    <div className="text-start mt-[20px]">
                        ...
                        <div className="flex flex-col gap-[15px] mt-[10px]">
                            <a className="font-[400] text-[14px] text-[#4C4C4D] text-end" href="">
                                Forgot Password?
                            </a>
                            <div className="flex  items-center gap-2">
                                <input value={false} type="checkbox" className="checkbox checkbox-warning" />
